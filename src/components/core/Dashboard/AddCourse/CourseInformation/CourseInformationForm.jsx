...
const CourseInformationForm = () => {
  ...
  const onSubmit = async (data) => {
    console.log("CourseInformation data", data);
    if (editCourse) {
      if (isFormUpdated()) {
        const currentValues = getValues();
        ...
        if (currentValues.coursShortDesc !== course.courseDescription) {
    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        <label className="text-sm text-richblack-5" htmlFor="courseShortDesc">
          Course Short Decription<sup className="text-pink-200">*</sup>
        </label>
        <textarea
          id="courseShortDesc"
